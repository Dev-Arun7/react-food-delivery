...
const resList = [
  {
    ...
    analytics: {
      context: "seo-data-331e1077-a723-49cd-b695-886a9e627fe6",
    },
    cta: {
  ...
  },
  {
    info: {
      ...
      availability: {
        nextCloseTime: "2024-06-11 16:30:00",
        opened: true,
      },
      badges: {},
      isOpen: true,
  ...
  },
  {
    info: {
      ...
      availability: {
        nextCloseTime: "2024-06-12 02:30:00",
        opened: true,
      },
      badges: {
        textExtendedBadges: [
  ...
  return (
    <div className="footer">
      <div className="about">
        ...
        <h2> Food Delivery </h2>
        <h3> Contact </h3>
        <h4> Email: 123arunbalakrishnan@gmail.com</h4>
      </div>
